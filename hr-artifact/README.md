...
`public/index.html` should be the Claude artifact HTML export. Current deploy is **build 2026-09-18b** (18a plus multiple exam-score rows on an applicant). If you replace it, keep the shim script tag in `<head>`.
