...
hr-artifact/
  ...
  public/hr-recruit.js       ← Pipeline bulk import, consolidate duplicates, role filter, search, application file (loaded by the shim)
