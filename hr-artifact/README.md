...
Extractor contract (URL, headers, field map, seed roles `ro01`–`ro10`, soft-dedupe, one-shot Pipeline cleanup) and **Cassie’s Import from email steps**: `docs/applicants-ingest.md`.
